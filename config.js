...
export default {
   ...
   options: {
      ...
      owner: ["6283150866279"], // set owner number on here
   ...
   Exif: {
      packId: "https://wahyuofficial.mydurable.com",
      packName: `Sticker Ini Dibuat Oleh :`,
      packPublish: "ᴡᴀʜʏᴜ-ʙᴏᴛᴢ",
      packEmail: "wahyusudrajad18@gmail.com",
      packWebsite: "https://wahyuofficial.mydurable.com",
